const Title = () => {
  return (
    <header className={"py-5 relative w-full md:max-w-[360px] self-center"}>
      <div className={"bg-bingo-foggyDarkBlue border-[3px] border-bingo-foggyBlue"}>
        ...
        <div className={"w-full flex items-center justify-between px-2"}>
          ...
          />
          <h1 className={"uppercase text-6xl text-bingo-lightBlue title-stroke text-shadow"}>BINGO</h1>
          <img
            src={"/images/lights.svg"}
            className={"h-full w-[5px] object-cover"}
          />
